...
def get_ip():
    ip = input(f'{COLOR_CODE["RED"]}Enter ip:')
    ...
    try:
        ...
        if infoList.get("success"):
            ...
            print(
                f'     {COLOR_CODE["RED"]}{COLOR_CODE["RED"]} Континент:{COLOR_CODE["RED"]}   {infoList["continent"]}')
            ...
            print(
                f'     {COLOR_CODE["RED"]}{COLOR_CODE["RED"]} Почтовый код:{COLOR_CODE["RED"]}   {infoList["postal"]}')
...
class Info:
    def __init__(self):
        ...
        table.add_row(['Fake name : ', str(fake.name())])
        table.add_row(['Fake address : ', str(fake.address())])
        table.add_row(['Fake email : ', str(fake.email())])
        table.add_row(['Fake phone number : ', str(fake.phone_number())])
        table.add_row(['Fake job : ', str(fake.job())])
        table.add_row(['Fake company : ', str(fake.company())])
        table.add_row(['Fake credit card number : ', str(fake.credit_card_number())])
        table.add_row(['Fake credit card security code : ', str(fake.credit_card_security_code())])
        table.add_row(['Fake credit card expiration date : ', str(fake.credit_card_expire())])
        table.add_row(['Fake credit card type : ', (fake.credit_card_provider())])
        table.add_row(['Fake IBAN : ', str(fake.iban())])
        table.add_row(['Fake BIC : ', str(fake.bban())])
        table.add_row(['Fake country : ', str(fake.country())])
        table.add_row(['Fake city : ', str(fake.city())])
...
if select == '1':
    ...
    lin = input(str('Link(must have http or https): '))
    get_link(lin)
    get_content(link)
elif select == '5':
    ...
    try:
        if search_value == 'b':
            save_file_from_google_drive(
                'https://drive.google.com/file/d/1iasG4fD8nidNLQtHY_r67CANA2PR8U-o/view?usp=sharing', 'Beeline2019.csv')
    ...
    try:
        if search_value == 'g':
            save_file_from_google_drive(
                'https://drive.google.com/file/d/1YBTJqibhavl50EnReyUlMl3dQJ0JCKq5/view?usp=sharing', 'Get1.csv')
            save_file_from_google_drive(
                'https://drive.google.com/file/d/13L8uq0RxriK7v9wbpbtAUAFSXoxix8by/view?usp=sharing', 'Get2.csv')
            save_file_from_google_drive(
                'https://drive.google.com/file/d/1YANpC9jrQzCQ6B2EA3ExrfKgC6cYSmjl/view?usp=sharing', 'Get3.csv')
            save_file_from_google_drive(
                'https://drive.google.com/file/d/1rMrfs2UeYq4F5mizZ3XYJX4Gzpf3Vurt/view?usp=sharing', 'Getcontact .csv')
    except:
        print("ERROR")
    try:
        if search_value == 'base1':
            save_file_from_google_drive(
                'https://drive.google.com/file/d/1B2qdnCN4juTt2-GwZsvyGnnqxNLxzJIM/view?usp=sharing', 'ny.csv')
            save_file_from_google_drive(
                'https://drive.google.com/file/d/1mG9pbuLWR8uiHOy5pr07bSqWkpBxX5pN/view?usp=sharing', 'rit.csv')
            save_file_from_google_drive(
                'https://drive.google.com/file/d/1WXU9CMvnTV8xXnQdf0sFkEakYTXc768C/view?usp=sharing', 'viм.csv')
            save_file_from_google_drive(
                'https://drive.google.com/file/d/1G6vrfgt8c36F-Bw3S376sVoquR6Gl4iw/view?usp=sharing', '772.csv')
            save_file_from_google_drive(
                'https://drive.google.com/file/d/1YMRlYlVwO2ZdqyY6AtZ38QECkYhMg6tn/view?usp=sharing',
                'russkoe-slovo.ru_cleaned.csv')
            save_file_from_google_drive(
                'https://drive.google.com/file/d/1_enul5KW7wAxRzd5Y0qNYcVJHtEOGKV3/view?usp=sharing', 'number2.csv')
            save_file_from_google_drive(
                'https://drive.google.com/file/d/1-bkQ3Zpr8xXXI4I8r2FV0-Qsq8ABgq6i/view?usp=sharing', 'tele2.csv')
            save_file_from_google_drive(
                'https://drive.google.com/file/d/17X9Q_wMrHNRx7r4FNhpGAgNCZuIYhERM/view?usp=sharing', 'Beeline2019.csv')
            save_file_from_google_drive(
                'https://drive.google.com/file/d/1YBTJqibhavl50EnReyUlMl3dQJ0JCKq5/view?usp=sharing', 'Get1.csv')
            save_file_from_google_drive(
                'https://drive.google.com/file/d/13L8uq0RxriK7v9wbpbtAUAFSXoxix8by/view?usp=sharing', 'Get2.csv')
            ...
            save_file_from_google_drive(
                'https://drive.google.com/file/d/1rMrfs2UeYq4F5mizZ3XYJX4Gzpf3Vurt/view?usp=sharing', 'Getcontact .csv')
            save_file_from_google_drive(
                'https://drive.google.com/file/d/1-t5NDGmOP8ZLyMBktbxhMyturLjpa_Bv/view?usp=sharing', 'podruzhka.sql')
            save_file_from_google_drive(
                'https://drive.google.com/file/d/1-xCpjkvQHlHCBYTfQx09tXA-MkKjftcg/view?usp=sharing', 'luk.txt')
            save_file_from_google_drive(
                'https://drive.google.com/file/d/1iuLKhLilKkUAOjMXUqfqr3w2QZrwNmWF/view?usp=sharing',
                'sportmaster_1.txt')
            save_file_from_google_drive(
                'https://drive.google.com/file/d/1XFOjBt3HQFMVRoAa90CcHpzrjiU8xRYW/view?usp=sharing',
                'sportmaster_2.txt')
            save_file_from_google_drive(
                'https://drive.google.com/file/d/16dronJMv2qgoj6cJzuXmQd4cP_URursM/view?usp=sharing',
                'sportmaster_3.txt')
            save_file_from_google_drive(
                'https://drive.google.com/file/d/1uaXey-fzVTRqwbgMNNZpVCx0tZ_HczL-/view?usp=sharing', 'aliy.csv')
            save_file_from_google_drive(
                'https://drive.google.com/file/d/1uY8i_uwXwruDGN6KuNdRKm6UQj_S-OuU/view?usp=sharing', 'tyr.sql.csv')
            save_file_from_google_drive(
                'https://drive.google.com/file/d/1PbudIa8b6rA7Ds2vmrjZQTq3iZ_T8GXo/view?usp=sharing', 'vk (1).txt')
            save_file_from_google_drive(
                'https://drive.google.com/file/d/1YiRiLE_EaQ4g_pM_pYBZEvbLkAt2ZdUE/view?usp=sharing', 'vk1.csv')
    ...
    try:
        if search_value == 'avto':
            save_file_google_drive('https://drive.google.com/file/d/16eh99quOxYGWTfyTEKkBlPvUug9FfXKi/view?usp=sharing',
                                   '1.csv')
    ...
    try:
        if search_value == 'tg':
            save_from_google_drive('https://drive.google.com/file/d/1vTzYRJoMq8t1KcvPHnMPfs3Xdl2DLUZg/view?usp=sharing',
                                   'id.csv')
            save_from_google_drive('https://drive.google.com/file/d/1k_GzqyCou2NSlGsLdt_Jve-Ss0Ig4DQQ/view?usp=sharing',
                                   'csv.fixed.txt')
            save_from_google_drive('https://drive.google.com/file/d/1s_IUEAd3K1A5cN3y41d3B356Sk9ZAfyi/view?usp=sharing',
                                   'telegram users 520k, 10k numbers.txt')
    except:
        print("ERROR")
    try:
    ...
    try:
        if search_value == '100m':
            save_file_100m('https://drive.google.com/file/d/1hbTiyRBAPnOvhFmR2XyHKvSMBdqrf4rO/view?usp=sharing',
                           '100mln_0.csv')
            save_file_100m('https://drive.google.com/file/d/1dH4tghxRUu5DV4etb0liFPZqmehwPtPX/view?usp=sharing',
                           '100mln_1.csv')
            save_file_100m('https://drive.google.com/file/d/1m5jhOAUvlh4GVXc3VE-_HDwFI9bU2wmK/view?usp=sharing',
                           '100mln_3.csv')
            save_file_100m('https://drive.google.com/file/d/1VoVC1GFYBuVuInfZHL5DYqDiPuDkJ28t/view?usp=sharing',
                           'getcontact-2.csv')
            save_file_100m('https://drive.google.com/file/d/10qdcsv71e096HpDy9p5gXo1geaPTT1hW/view?usp=sharing',
                           'getcontact-3.csv')
    except:
        print("ERROR")
    try:
